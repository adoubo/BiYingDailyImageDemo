...
public class IcibaBean {
    ...
    public String getFengxiang_img() {
        return fengxiang_img;
    }

    public void setFengxiang_img(String fengxiang_img) {
        this.fengxiang_img = fengxiang_img;
    }
}
